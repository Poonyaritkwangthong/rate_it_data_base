...
class SummarizeController extends Controller
{
    ...
    public function create($id)
    {
        ...
        return view('page.capacity_rate_it.summarize.create', compact('personal', 'assessment_01', 'assessment_02', 'evaluation_component', 'criterion_choice', 'assessment_acknowledgement_choice', 'comment_choice'));
    }
